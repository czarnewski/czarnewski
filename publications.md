# <img border="0" src="/czarnewski/logos/publications.png" width="40" height="40" style="vertical-align:middle;"> Publications
...
<div class="tooltip" style="overflow: hidden; border-radius: 10px; background: green;   margin: 1px;
width: 40px; height: 40px;">
  <img class="zoom minibutton" src="/czarnewski/logos/data_analysis.png">
  <span class="tooltiptext">bioinformatics analysis</span>
</div>
<div class="tooltip" style="overflow: hidden; border-radius: 10px; background: red;   margin: 1px;
width: 40px; height: 40px;">
